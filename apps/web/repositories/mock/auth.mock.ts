...
export class MockAuthRepository implements IAuthRepository {
        ...
        if (!req.email || !req.password || !req.full_name) {
            throw {
                error: {
                    ...
                    details: [{ loc: ['body'], msg: 'Required fields missing', type: 'missing' }],
                },
            };
        }
    ...
    public async login(req: LoginRequest): Promise<TokenPair> {
        ...
        throw {
            error: {
                code: 'unauthorized',
                message: 'Invalid credentials. Use email owner@example.com and password supersecret1',
                details: null,
            },
        };
    }
    ...
    public async refresh(req: RefreshRequest): Promise<TokenPair> {
        ...
        return {
            ...
            refresh_token: 'mock-refresh-token-refreshed-' + Math.random().toString(36).substr(2, 9),
            token_type: 'bearer',
        };
    }
