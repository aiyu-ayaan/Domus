    ...
    callback({
      responseHeaders: {
        ...
        'Content-Security-Policy': [
          electronIsDev
            ? `default-src ${customScheme}://* 'unsafe-inline' devtools://* 'unsafe-eval' data:; connect-src *; img-src * data: blob:;`
            : `default-src ${customScheme}://* 'unsafe-inline' data:; connect-src *; img-src * data: blob:;`,
        ],
      },
    });
  });
