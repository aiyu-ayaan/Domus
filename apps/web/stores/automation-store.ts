  ...
  fetchAutomations: async (homeId) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error:
          err?.error?.message || err?.message || "Failed to load automations",
      });
    }
  },
  ...
  createAutomation: async (req) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error:
          err?.error?.message || err?.message || "Failed to create automation",
      });
      throw err;
    }
  },
  ...
  updateAutomation: async (id, req) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error:
          err?.error?.message || err?.message || "Failed to update automation",
      });
      throw err;
    }
  },
  ...
  deleteAutomation: async (id) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error:
          err?.error?.message || err?.message || "Failed to delete automation",
      });
      throw err;
    }
  },
