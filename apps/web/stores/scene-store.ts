...
export const useSceneStore = create<SceneState>((set) => ({
    ...
    fetchScenes: async (homeId) => {
        ...
        try {
            ...
            set({ isLoading: false, error: err?.error?.message || err?.message || 'Failed to load scenes' });
        }
    },
    ...
    createScene: async (req) => {
        ...
        try {
            ...
            set({ isLoading: false, error: err?.error?.message || err?.message || 'Failed to create scene' });
            throw err;
        }
    },
    ...
    updateScene: async (id, req) => {
        ...
        try {
            ...
            set({ isLoading: false, error: err?.error?.message || err?.message || 'Failed to update scene' });
            throw err;
        }
    },
    ...
    deleteScene: async (id) => {
        ...
        try {
            ...
            set({ isLoading: false, error: err?.error?.message || err?.message || 'Failed to delete scene' });
            throw err;
        }
    },
