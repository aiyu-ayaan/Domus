...
export const useRoomStore = create<RoomState>((set) => ({
  ...
  fetchRooms: async (homeId) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error: err?.error?.message || err?.message || "Failed to load rooms",
      });
    }
  },
  ...
  createRoom: async (req) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error: err?.error?.message || err?.message || "Failed to create room",
      });
      throw err;
    }
  },
  ...
  updateRoom: async (id, req) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error: err?.error?.message || err?.message || "Failed to update room",
      });
      throw err;
    }
  },
  ...
  deleteRoom: async (id) => {
    ...
    try {
      ...
      set({
        isLoading: false,
        error: err?.error?.message || err?.message || "Failed to delete room",
      });
      throw err;
    }
  },
