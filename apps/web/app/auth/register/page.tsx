        ...
        <div className="flex min-h-screen items-center justify-center p-4 sm:p-6">
            <div className="w-full max-w-md space-y-6">
                ...
                <div className="text-center">
                    ...
                    <h2 className="font-display text-3xl font-bold tracking-tight">Create Owner Account</h2>
                    <p className="text-sm text-muted-foreground mt-2">
                        The first account registered on this server is granted the **Owner** role.
                    </p>
                </div>
                ...
                <div className="rounded-3xl border border-border bg-card/40 p-6 sm:p-8 backdrop-blur-md shadow-glow">
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            {errors.fullName && (
                                <p className="text-xs text-rose-500 font-semibold">{errors.fullName.message}</p>
                            )}
                        </div>
                ...
                <div className="text-center text-xs text-muted-foreground">
                    ...
                    <Link href="/auth/login" className="font-semibold text-primary hover:underline cursor-pointer">
                        Sign In
                    </Link>
                </div>
            </div>
