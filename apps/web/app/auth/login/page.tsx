        ...
        <div className="flex min-h-screen items-center justify-center p-4 sm:p-6">
            <div className="w-full max-w-md space-y-6">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        <div className="flex items-center">
                            <input
                                ...
                                {...register('rememberMe')}
                            />
                            <label htmlFor="remember-me" className="ml-2 text-xs font-medium text-muted-foreground cursor-pointer select-none">
                ...
                <div className="text-center text-xs text-muted-foreground">
                    ...
                    <Link href="/auth/register" className="font-semibold text-primary hover:underline cursor-pointer">
                        Register Home Owner
                    </Link>
                </div>
            </div>
