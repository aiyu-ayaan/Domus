...
export default function SettingsPage() {
    ...
    return (
        <div className="space-y-6">
            <PageHeader title="Settings" description="Configure profile parameters, appearance modes, and security." />
                ...
                <TabsContent value="profile">
                    <div className="rounded-3xl border border-border/60 bg-card/25 p-5 max-w-xl backdrop-blur-sm space-y-5">
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-1">Manage details linked to your account.</p>
                        </div>
                        ...
                        <form onSubmit={handleProfileSubmit(onProfileSubmit)} className="space-y-4">
                            <div className="space-y-1">
                                ...
                                />
                                {profileErrors.fullName && <p className="text-xs text-rose-500 font-semibold">{profileErrors.fullName.message}</p>}
                            </div>
                            ...
                            <div className="space-y-1">
                                ...
                                />
                                {profileErrors.avatarUrl && <p className="text-xs text-rose-500 font-semibold">{profileErrors.avatarUrl.message}</p>}
                            </div>
                ...
                <TabsContent value="appearance">
                    <div className="rounded-3xl border border-border/60 bg-card/25 p-5 max-w-xl backdrop-blur-sm space-y-5">
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-1">Select theme styles for the Domus OS interface.</p>
                        </div>
                ...
                <TabsContent value="homes">
                    <div className="rounded-3xl border border-border/60 bg-card/25 p-5 max-w-xl backdrop-blur-sm space-y-4">
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-1">Homes managed under this account scope.</p>
                        </div>
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] text-muted-foreground mt-0.5">{home.timezone}</p>
                                        </div>
                                    </div>
                ...
                <TabsContent value="security">
                    <div className="rounded-3xl border border-border/60 bg-card/25 p-5 max-w-xl backdrop-blur-sm space-y-5">
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-1">Update login password credentials.</p>
                        </div>
                        ...
                        <form onSubmit={handlePasswordSubmit(onPasswordSubmit)} className="space-y-4">
                            <div className="space-y-1">
                                ...
                                {passwordErrors.currentPassword && <p className="text-xs text-rose-500 font-semibold">{passwordErrors.currentPassword.message}</p>}
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    ...
                                    />
                                    {passwordErrors.newPassword && <p className="text-xs text-rose-500 font-semibold">{passwordErrors.newPassword.message}</p>}
                                </div>
                                <div className="space-y-1">
                                    ...
                                    />
                                    {passwordErrors.confirmPassword && <p className="text-xs text-rose-500 font-semibold">{passwordErrors.confirmPassword.message}</p>}
                                </div>
                            </div>
                            ...
                            <div className="rounded-xl border border-amber-500/25 bg-amber-500/5 p-3 flex items-start gap-2.5">
                                ...
                                <p className="text-[10px] text-muted-foreground leading-normal">
                                    Saving a new password invalidates all other active session refresh tokens. You will need to log in again on other devices.
                                </p>
                            </div>
